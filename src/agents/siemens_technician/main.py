...
async def consult(request: ConsultRequest):
    ...
    try:
        ...
        if not context:
            context = "No relevant equipment or pain point data found."
...
if __name__ == "__main__":
    ...
    port = int(os.getenv("SIEMENS_TECHNICIAN_PORT", "8002"))

    logger.info(f"Starting Siemens Technician on port {port}...")
